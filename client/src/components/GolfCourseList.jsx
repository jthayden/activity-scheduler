...
export default class GolfCourseList extends Component {
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <Link to={`/golfcourses/${golf_course.id}`}>
                    <Typography component="span" className="imageTitle">
                    {golf_course.name}
                    </Typography>
                </Link>
                </span>
        ...
        <div className="golf-course-list">
            <Button href="#The Preserve" className="course-link">
            The Preserve
            </Button>
            <Button href="#The Oconee" className="course-link">
            The Oconee
            </Button>
            <Button href="#Great Waters" className="course-link">
            Great Waters
            </Button>
            <Button href="#The National" className="course-link">
            The National
            </Button>
            <Button href="#The Creek Club" className="course-link">
            {" "}
            The Creek Club
            </Button>
            <Button href="#The Landing" className="course-link">
            The Landing
            </Button>
